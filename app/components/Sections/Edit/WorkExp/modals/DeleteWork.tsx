...
const DeleteWork: React.FC<DeleteWorkProps> = ({
  open,
  onClose,
  onConfirm,
}) => {
  ...
  const handleConfirm = () => {
    onConfirm();
    notify(t("section.workExperience.notify.deleted"), "error");
  };
  return (
    <div
    ...
    >
      <div className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-lg w-full max-w-sm">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
          {t("section.workExperience.modal.deleteModal")}
        </h2>

        <p className="text-gray-700 dark:text-gray-300 mb-6 text-sm">
          {t("section.workExperience.modal.subtitleDeleteModal")}
        </p>
